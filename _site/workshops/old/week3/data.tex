...
\part Declare and instantiate an object \texttt{myTime} of class \texttt{Time} written in the previous part. Assign values to the data members such that it represents the time 19:30:45 (half past seven in the evening and another 45 seconds).
...
\part Declare and instantiate an object \texttt{yourTime} of class \texttt{Time} written in the previous part. Assign 95 to \texttt{hour}, -78 to minute, and 55 to second. Display all data members on the console. What time would \texttt{yourTime} represent?
...
\end{solution}
\end{parts}
\question {\bf Programming Exercise to be Submitted}\\
Write a class definition for a \texttt{Line} in the first quadrant, as represented by its end points $(x_1, y_1)$ and $(x_2, y_2)$ such that $x_1, y_1, x_2, y_2 \geq 0$. It should include,
