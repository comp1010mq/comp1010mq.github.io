...
\draw (0,0) -- (12.8,0) -- (12.8,0.5) -- (0,0.5) -- (0,0);
\foreach \x in {0,8,16,...,64}
	\draw (\x/5, 0) -- (\x/5, 0.5) node[anchor=south] {\x};
...
\foreach \x in {0,8,16,...,64}
	\draw (\x/5, 0) -- (\x/5, 0.5) node[anchor=south] {\x};
\filldraw[fill=blue, draw=black] (1.6, 0) rectangle(12.8, 0.5);
\filldraw[fill=red, draw=black] (0, 0) rectangle(1.6, 0.5);
\end{tikzpicture} \egroup
\vskip 1cm
...
\foreach \x in {0,8,16,...,64}
	\draw (\x/5, 0) -- (\x/5, 0.5) node[anchor=south] {\x};
\filldraw[fill=red, draw=black] (0, 0) rectangle(11.2, 0.5);
\filldraw[fill=blue, draw=black] (11.2, 0) rectangle(12.8, 0.5);
\end{tikzpicture} \egroup
\vskip 1cm
...
\foreach \x in {0,8,16,...,64}
	\draw (\x/5, 0) -- (\x/5, 0.5) node[anchor=south] {\x};
\filldraw[fill=red, draw=black] (0, 0) rectangle(6.4, 0.5);
\filldraw[fill=blue, draw=black] (6.4, 0) rectangle(12.8, 0.5);
\end{tikzpicture} \egroup
\vskip 1cm
...
\foreach \x in {0,8,16,...,64}
	\draw (\x/5, 0) -- (\x/5, 0.5) node[anchor=south] {\x};
\filldraw[fill=red, draw=black] (0, 0) rectangle(3.2, 0.5);
\filldraw[fill=blue, draw=black] (3.2, 0) rectangle(6.4, 0.5);
\filldraw[fill=black!10!white, draw=black] (6.4, 0) rectangle(12.8, 0.5);
\end{tikzpicture} \egroup
\vskip 1cm
...
\foreach \x in {0,8,16,...,64}
	\draw (\x/5, 0) -- (\x/5, 0.5) node[anchor=south] {\x};
\filldraw[fill=red, draw=black] (6.4, 0) rectangle(9.6, 0.5);
\filldraw[fill=blue, draw=black] (9.6, 0) rectangle(12.8, 0.5);
\filldraw[fill=black!10!white, draw=black] (0, 0) rectangle(6.4, 0.5);
\end{tikzpicture} \egroup
\end{enumerate}
...
\foreach \x in {0,8,16,...,64}
	\draw (\x/5, 0) -- (\x/5, 0.5) node[anchor=south] {\x};
\filldraw[fill=red, draw=black] (3.2, 0) rectangle(4.8, 0.5);
\filldraw[fill=blue, draw=black] (4.8, 0) rectangle(6.4, 0.5);
\filldraw[fill=black!10!white, draw=black] (0, 0) rectangle(3.2, 0.5);
\filldraw[fill=black!10!white, draw=black] (6.4, 0) rectangle(12.8, 0.5);
\end{tikzpicture} \egroup
Feedback: Lower
\vskip 1cm
...
\foreach \x in {0,8,16,...,64}
	\draw (\x/5, 0) -- (\x/5, 0.5) node[anchor=south] {\x};
\filldraw[fill=red, draw=black] (3.2, 0) rectangle(4.0, 0.5);
\filldraw[fill=blue, draw=black] (4.0, 0) rectangle(4.8, 0.5);
\filldraw[fill=black!10!white, draw=black] (0, 0) rectangle(3.2, 0.5);
\filldraw[fill=black!10!white, draw=black] (4.8, 0) rectangle(12.8, 0.5);
\end{tikzpicture} \egroup
Feedback: Lower
\vskip 1cm
...
\bgroup \tikzset{png export} \begin{tikzpicture}
\draw (0,0) -- (12.8,0) -- (12.8,0.5) -- (0,0.5) -- (0,0);
\foreach \x in {0,4,8,12,16,...,64}
	\draw (\x/5, 0) -- (\x/5, 0.5) node[anchor=south] {\scriptsize \x};
\filldraw[fill=red, draw=black] (3.2, 0) rectangle(3.6, 0.5);
\filldraw[fill=blue, draw=black] (3.6, 0) rectangle(4.0, 0.5);
\filldraw[fill=black!10!white, draw=black] (0, 0) rectangle(3.2, 0.5);
\filldraw[fill=black!10!white, draw=black] (4.0, 0) rectangle(12.8, 0.5);
\end{tikzpicture} \egroup
Feedback: Lower
\vskip 1cm
...
\bgroup \tikzset{png export} \begin{tikzpicture}
\draw (0,0) -- (12.8,0) -- (12.8,0.5) -- (0,0.5) -- (0,0);
\foreach \x in {0,2,4,...,64}
	\draw (\x/5, 0) -- (\x/5, 0.5) node[anchor=south] {\tiny \x};
\filldraw[fill=red, draw=black] (3.2, 0) rectangle(3.4, 0.5);
\filldraw[fill=blue, draw=black] (3.4, 0) rectangle(3.6, 0.5);
\filldraw[fill=black!10!white, draw=black] (0, 0) rectangle(3.2, 0.5);
\filldraw[fill=black!10!white, draw=black] (3.6, 0) rectangle(12.8, 0.5);
\end{tikzpicture} \egroup
