...
public class ConsistentState {
	...
	static ConsistentState instance = null;
	 ...
	 *  
	 * @param value the value to update the current state with,
	 */
	public synchronized void setValues(long value) {
		this.value = value;
		doPause(3);
